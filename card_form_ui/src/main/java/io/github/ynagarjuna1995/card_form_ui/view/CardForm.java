...
import io.github.ynagarjuna1995.card_form_ui.CardScanningFragment;
import io.github.ynagarjuna1995.card_form_ui.OnCardFormFieldFocusedListener;
import io.github.ynagarjuna1995.card_form_ui.OnCardFormSubmitListener;
import io.github.ynagarjuna1995.card_form_ui.OnCardFormValidListener;
import io.github.ynagarjuna1995.card_form_ui.R;
import io.github.ynagarjuna1995.card_form_ui.utils.CardType;
import io.github.ynagarjuna1995.card_form_ui.utils.ViewUtils;
...
public class CardForm extends LinearLayout implements CardEditText.OnCardTypeChangedListener, OnFocusChangeListener, OnClickListener,
    ...
    private ImageButton mScanCardBtn;
...
//        mMobileNumberIcon = findViewById(R.id.bt_card_form_mobile_number_icon);
        ...
        mScanCardBtn = findViewById(R.id.scan_card);

        mScanCardBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                scanCard((Activity) v.getContext());
            }
        });
     ...
     * {@link CardForm#expirationRequired(boolean)}, ect. If {@link #setup(Activity)} is not called,
...
//    }
    ...
    /**
     * Set the listener to receive a callback when the {@link } changes.
     *
     * @param listener to receive the callback
     */
